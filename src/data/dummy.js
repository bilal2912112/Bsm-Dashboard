...
import { BsGraphUp, BsCardList, BsCart2 } from "react-icons/bs";
import { BiListOl, BiFileBlank } from "react-icons/bi";
...
import product6 from "./product5.jpg";
...
export const gridOrderImage = (props) => (
  <div>
    <img
      className="rounded-xl h-7 bg-slate-300 md:ml-3"
...
export const sampleData = [
  { name: "Electronic", price: "270$", value: 37, text: "37%" },
  { name: "Fashion", price: "270$", value: 17, text: "17%" },
  { name: "Furniture", price: "270$", value: 19, text: "19%" },
  { name: "Other", price: "270$", value: 11, text: "4%" },
];
...
export const links = [
  { name: "SalesAnalytics", icon: <BsGraphUp /> },
  { name: "RegisterBrands", icon: <BiListOl /> },
  { name: "RegisterNewBrands", icon: <FiDatabase /> },
  { name: "Plans", icon: <BiFileBlank /> },
  { name: "Payments", icon: <FiCreditCard /> },
  { name: "Report", icon: <BsCardList /> },
  { name: "Setting", icon: <FiSettings /> },
];
export const Owner_links = [
  { name: "SalesAnalytics", name1: "Sales Analytics", icon: <BsGraphUp /> },
  {
    name: "Shope_Sale_Summary",
    name1: "Shope Sale Summary",
    icon: <BiListOl />,
  },
  { name: "Employee", name1: "Employee", icon: <FiDatabase /> },
  { name: "Branches", name1: "Branches", icon: <FiDatabase /> },
  { name: "Payments", name1: "Payments", icon: <FiCreditCard /> },
  { name: "Report", name1: "Report", icon: <BsCardList /> },
  { name: "Setting", name1: "Setting", icon: <FiSettings /> },
];
...
export const PlanData = [
  {
    BasicPlan:
      "In our basic plan you can take the advantage of all these features below",
    ProPlan:
      "Our most popular package is pro plan which gives you access of following:",
    PremiumPlan: "With our Premium you can take the advantage of below",
  },
  {
    BasicPlan: "10 user included",
    ProPlan: "10 user included",
    PremiumPlan: "10 user included",
  },
  {
    BasicPlan: "2GB of Storage",
    ProPlan: "2GB of Storage",
    PremiumPlan: "2GB of Storage",
  },
  {
    BasicPlan: "2GB of Storage",
    ProPlan: "2GB of Storage",
...
export const paymentData = [
  {
    ...
    brandName: "bata",
    Date: "may 26,2022",
    Description: "paid via masterCard",
    Status: "pending",
    StatusBg: "#FB9678",
    payments: "$648.00",
  },
