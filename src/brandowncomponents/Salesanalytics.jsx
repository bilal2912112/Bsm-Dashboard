...
const salesanalytics = () => {
  return (
    <div className="m-2 md:m-5 mt-24 p-2 md:p-5 ">
      <Header
        ...
        title="Weekly SumUp"
      />
      <div class="grid grid-cols-1 gap-4 sm:w-full md:grid-cols-3 ">
        <div
 ...
 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl"
        >
          ...
          <div class="flex flex-wrap lg:flex-nowrap justify-between  pt-5">
            <div class="flex-auto w-80 ...">
              ...
              <div class="flex text-sm justify-between pt-5">
            ...
            <div class="pl-5 text-right py-5 col-span-3  md:w-64 ">
              {" "}
              {/* <div class="">
                {" "}
                <h1 className=" mt-2">
              ...
              <section className="text-sm text-gray-500 pr-12">
                Current Balance
              </section>
              <div class="flex justify-center text-green-600 ">
                ...
                <div>
                  <p className="text-xl mt-3">233233.32</p>
                </div>
              </div>
              <section className="text-sm text-gray-500 pr-20">Income</section>
              <div class="flex justify-center text-red-600 ">
                ...
                <div>
                  <p className="mt-3 ">233233.32</p>
                </div>
              </div>
              <section className="text-sm text-gray-500 pr-20">Outcome</section>
              <FcBusinessman className="   mt-5 " />
            </div>
          </div>
        </div>
 ...
 dark:bg-secondary-dark-bg my-3 py-4 rounded-2xl   md:w-64  "
          >
            ...
            <p className="text-gray-400 text-center">Amount Used</p>
            <p className="py-1 font-bold text-center  ">Account Balance</p>
            <p className="text-sm pl-3">{`you have left ${480}$ of your credit `}</p>
            <div class="grid grid-cols-2 gap-4 pl-3 pt-5">
              <div class="col-start-1 text-xs col-end-3 text-gray-400">
                Used Amount:
              </div>
              <div class="col-end-7 col-span-2 text-blue-500 pr-3">280$</div>
              <div class="col-start-1 col-end-3 text-gray-400 text-xs">
                Used Amount:
              </div>
